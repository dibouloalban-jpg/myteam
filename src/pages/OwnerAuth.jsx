...
export default function OwnerAuth() {
  ...
  async function handleAuth(e) {
    ...
    try {
      ...
      if (!signInError) {
        toast.success('Connexion réussie ! Bienvenue dans votre espace Owner.')
        navigate('/Dashboard')
        return
      }
      ...
      toast.success('Compte Owner créé avec succès ! Vérifiez votre e-mail pour activer votre compte.')
    } catch (error) {
    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-100 to-blue-50 flex flex-col items-center justify-center font-sans relative overflow-hidden">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold text-blue-600 mb-6">
          Bienvenue sur l’espace <span className="text-white bg-blue-500 border-4 border-blue-300 rounded-xl px-3 py-1">Owner</span>
        </h1>
        <p className="text-gray-700 text-lg mb-10 leading-relaxed">
          Cet espace est dédié aux créateurs d’équipe et aux responsables de projet. 
          Inscrivez-vous ou connectez-vous pour accéder à vos outils de gestion, suivre vos collaborateurs et bâtir la meilleure équipe possible. 
          Notre plateforme est là pour vous accompagner à chaque étape de votre réussite.
        </p>
